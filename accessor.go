...
// InterfacePtr cast field pointer to **interface{}
func (f *Field) InterfacePtr(structPtr unsafe.Pointer) *interface{} {
	result := f.AsInterfaceAddrPtr(f.Pointer(structPtr))
	if result == nil {
		return nil
	}
	return *result
